...
namespace DiscordSink
{
    ...
    {   
        ...
        internal IReadOnlyList<ulong> Info
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Information) select c.Key) as List<ulong>;
            }
        }
        ...
        internal IReadOnlyList<ulong> Debug
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Debug) select c.Key) as List<ulong>;
            }
        }
        ...
        internal IReadOnlyList<ulong> Warning
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Warning) select c.Key) as List<ulong>;
            }
        }
        ...
        internal IReadOnlyList<ulong> Error
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Error) select c.Key) as List<ulong>;
            }
        }
        ...
        internal IReadOnlyList<ulong> Fatal
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Fatal) select c.Key) as List<ulong>;
            }
        }
        ...
        internal IReadOnlyList<ulong> Verb
        {
            get
            {
                return (from c in Levels where c.Value.HasFlag(LoggingLevel.Verbose) select c.Key) as List<ulong>;
            }
        }
        #endregion

        internal void ProccessWithClient(ref DiscordSocketClient client)
        {
